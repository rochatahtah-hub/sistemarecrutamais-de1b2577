...
function PaginaLeads() {
  ...
  return <div className="min-h-screen bg-background">
    <header className="border-b border-sidebar-border bg-sidebar text-sidebar-foreground"><div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4"><img src={logoLockup.url} alt="RECRUTA+" className="h-10 w-auto" /><Button asChild variant="gold"><a href="#planos">Ver planos</a></Button></div></header>
